    ...
    <nav className={`${styles.paddingX} w-full flex-item-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between item-center max-w-7xl mx-auto'>
        <Link to="/" className='flex item-center gap-2' onClick={()=>{setActive(""); window.scrollTo(0, 0);}}>
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">Ark &nbsp;<span className='sm:block hidden'>| &nbsp; Portfolio</span> </p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          <img alt='menu' src={toggle ? close : menu} className='w-[28px] h-[28px] object-contain cursor-pointer' onClick={() => setToggle(!toggle)}/>
